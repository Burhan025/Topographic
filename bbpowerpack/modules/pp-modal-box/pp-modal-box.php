            ...
            'modal_content' => array(
                ...
                'fields'        => array(
                    ...
                    'modal_type'       => array(
                        ...
                        'toggle'        => array(
                            'photo'        => array(
                                'fields'        => array('modal_subtitle','modal_type_photo','modal_text_content')
                            ),
                            'video'         => array(
                    ...
                    'modal_subtitle'      => array(
                        'type'          => 'text',
                        'label'         => __('Sub Title', 'bb-powerpack'),
                        'default'       => __('Sub Title', 'bb-powerpack'),
                        'connections'   => array( 'string', 'html', 'url' ),
                        'preview'       => array(
                            'type'          => 'text',
                            'selector'      => '.pp-modal-subtitle'
                        )
                    ),
                    ...
                    'modal_text_content'   => array(
                        'type'                  => 'editor',
                        'label'                 => '',
                        'connections'           => array( 'string', 'html', 'url' ),
                        'preview'               => array(
                            'type'                  => 'text',
                            'selector'              => '.pp-modal-text-inner'
                        )
                    ),
