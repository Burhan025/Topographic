...
function parallax_enqueue_scripts_styles() {
	...
	wp_enqueue_style( 'scroll', get_stylesheet_directory_uri() . '/js/custom-scrollbar-plugin/jquery.mCustomScrollbar.css', array() );
	...
	wp_enqueue_script( 'scrolljs', get_stylesheet_directory_uri() . '/js/custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js', array('jquery') );

	wp_enqueue_script( 'scrollscript', get_stylesheet_directory_uri() . '/js/scroll.js', array('jquery') );
...
add_image_size( 'subpage-header', 1600, 342, true );
